...
import { motion } from "framer-motion"; // Framer Motion import කළා
...
export function AboutSection() {
  return (
    <section className="py-8 md:py-1">
      ...
      {/* Stats & CV Button Wrapper with Staggered Animation */}
      <motion.div 
      ...
      {/* Skill Cards with Hover & In-view Animations */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
        ...
        >
          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              <motion.div whileHover={{ rotate: 15 }} className="w-10 h-10 sm:w-12 sm:h-12 mb-3 sm:mb-4">
        ...
        >
          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              <motion.div whileHover={{ scale: 1.2 }} className="w-10 h-10 sm:w-12 sm:h-12 mb-3 sm:mb-4">
